...
For a little extra help with AASM (which I always need to reference), there is a text file called AASM.txt that merely provides an example of how to use AASM in the model.